...
// src/app/componets/dashbord/production-dashboard/productos/edit-producto/edit-producto.component.ts
function EditProductoComponent_ng_template_46_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function EditProductoComponent_ng_template_46_Conditional_3_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function EditProductoComponent_ng_template_46_Conditional_3_For_26_Template(rf, ctx) {
  if (rf & 1) {
...
function EditProductoComponent_ng_template_46_Conditional_3_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
...
function EditProductoComponent_ng_template_46_Conditional_3_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EditProductoComponent_ng_template_46_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 39);
    \u0275\u0275listener("ngSubmit", function EditProductoComponent_ng_template_46_Conditional_3_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275template(10, EditProductoComponent_ng_template_46_Conditional_3_Conditional_10_Template, 2, 1, "div", 46);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275repeaterCreate(25, EditProductoComponent_ng_template_46_Conditional_3_For_26_Template, 2, 2, "ng-option", 49, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(39, EditProductoComponent_ng_template_46_Conditional_3_Conditional_39_Template, 2, 1, "div", 54);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 41)(41, "div", 2)(42, "div", 42)(43, "label", 43);
    \u0275\u0275text(44, "Stock Actual *");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 44);
    \u0275\u0275element(46, "input", 55);
    \u0275\u0275template(47, EditProductoComponent_ng_template_46_Conditional_3_Conditional_47_Template, 2, 1, "div", 46);
    \u0275\u0275elementStart(48, "small", 56);
    \u0275\u0275text(49, 'Use la opci\xF3n "Actualizar Stock" para modificar el inventario');
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(50, "div", 57)(51, "div", 2)(52, "div", 42)(53, "label", 58);
    \u0275\u0275text(54, "Estado del Producto:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 44)(56, "div", 59);
    \u0275\u0275element(57, "input", 60);
    \u0275\u0275elementStart(58, "label", 61);
    \u0275\u0275text(59, "Activo/Inactivo");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EditProductoComponent_ng_template_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 33)(1, "div", 34);
    \u0275\u0275template(2, EditProductoComponent_ng_template_46_Conditional_2_Template, 4, 0, "div", 35)(3, EditProductoComponent_ng_template_46_Conditional_3_Template, 60, 11, "form", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var _EditProductoComponent = class _EditProductoComponent {
...
_EditProductoComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditProductoComponent, selectors: [["app-edit-producto"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 54, vars: 12, consts: [["nav", "ngbNav"], [3, "title"], [1, "row"], [1, "col-xxl-3", "col-xl-4", "col-md-12", "col-lg-12"], [1, "card", "box-widget", "widget-user", "custom-card"], [1, "card-body", "text-center"], [1, "widget-user-image", "mx-auto", "text-center"], [1, "fas", "fa-box", "fa-5x", "text-primary"], [1, "pro-user", "mt-3"], [1, "pro-user-username", "text-dark", "mb-1", "fs-16"], [1, "pro-user-desc", "text-muted", "fs-12"], [1, "card-footer", "p-0"], [1, "col-4", "text-center", "py-3", "border-end"], [1, "fs-12", "fw-semibold", "mb-3"], [1, "mb-2"], [1, "fs-18", "text-success"], [1, "fs-12", "mb-0"], [1, "col-4", "py-3", "text-center", "border-end"], [1, "fs-18", "text-primary"], [1, "col-4", "text-center", "py-3"], [1, "fs-18"], [1, "col-xxl-9", "col-xl-8", "col-md-12", "col-lg-12"], [1, "tab-menu-heading", "hremp-tabs", "p-0", "border-0"], [1, "tabs-menu1"], ["ngbNav", "", 1, "panel-tabs", 3, "activeIdChange", "activeId"], [3, "ngbNavItem"], ["ngbNavLink", ""], ["ngbNavContent", ""], [1, "panel-body", "tabs-menu-body", "hremp-tabs1", "p-0"], [1, "tab-content", 3, "ngbNavOutlet"], [1, "panel-footer", "text-end"], ["type", "button", 1, "me-2", "btn", "btn-primary", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], ["id", "tab1"], [1, "card-body"], [1, "text-center"], [3, "formGroup"], ["role", "status", 1, "spinner-border"], [1, "visually-hidden"], [3, "ngSubmit", "formGroup"], [1, "mb-4", "font-weight-bold"], [1, "form-group"], [1, "col-md-3"], [1, "form-label", "mb-0", "mt-2"], [1, "col-md-9"], ["type", "text", "formControlName", "nombre", "placeholder", "Ingrese el nombre del producto", 1, "form-control"], [1, "invalid-feedback"], ["type", "text", "formControlName", "tamanio", "placeholder", "Ej: XL, Jumbo, Grande", 1, "form-control"], ["formControlName", "categoria", "placeholder", "Seleccionar categor\xEDa", 1, "form-control", "custom-select", "p-0", 3, "clearable"], [3, "value"], [1, "mb-4", "mt-7", "font-weight-bold"], [1, "input-group"], [1, "input-group-text"], ["type", "number", "formControlName", "precio", "placeholder", "0.00", "step", "0.01", "min", "0.01", 1, "form-control"], [1, "invalid-feedback", "d-block"], ["type", "number", "formControlName", "stock", "placeholder", "0", "min", "0", "readonly", "", 1, "form-control"], [1, "text-muted"], [1, "form-group", "mt-7"], [1, "form-label"], [1, "form-check", "form-check-md", "form-switch"], ["type", "checkbox", "formControlName", "activo", "role", "switch", "id", "switch-activo", 1, "form-check-input"], ["for", "switch-activo", 1, "form-check-label", "mt-0", "custom-switch-description"]], template: function EditProductoComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("activeIdChange", function EditProductoComponent_Template_ul_activeIdChange_41_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(46, EditProductoComponent_ng_template_46_Template, 4, 1, "ng-template", 27);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(47, "div", 28);
    \u0275\u0275element(48, "div", 29);
    \u0275\u0275elementStart(49, "div", 30)(50, "button", 31);
    \u0275\u0275listener("click", function EditProductoComponent_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onSubmit());
    });
    \u0275\u0275text(51, " Actualizar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "button", 32);
    \u0275\u0275listener("click", function EditProductoComponent_Template_button_click_52_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("title", "Editar Producto");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx.productoForm.get("nombre")) == null ? null : tmp_2_0.value) || "Editar Producto");
    \u0275\u0275advance(2);
...
}, dependencies: [CommonModule, RouterModule, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, CheckboxControlValueAccessor, NgControlStatus, NgControlStatusGroup, MinValidator, FormGroupDirective, FormControlName, NgSelectModule, NgSelectComponent, NgOptionComponent, NgbModule, NgbNavContent, NgbNav, NgbNavItem, NgbNavItemRole, NgbNavLink, NgbNavLinkBase, NgbNavOutlet, SharedModule, HrDashboardPageHeaderComponent], encapsulation: 2 });
var EditProductoComponent = _EditProductoComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditProductoComponent, { className: "EditProductoComponent" });
})();
export {
  EditProductoComponent
};
//# sourceMappingURL=edit-producto.component-DQKOV3US.js.map
