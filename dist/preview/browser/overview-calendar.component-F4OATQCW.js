...
// src/app/componets/dashbord/task-dashboard/overview-calendar/overview-calendar.component.ts
...
_OverviewCalendarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OverviewCalendarComponent, selectors: [["app-overview-calendar"]], viewQuery: function OverviewCalendarComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "Task Overview This Month");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    \u0275\u0275property("title", "Task Overview Calendar")("title3", "Task");
    \u0275\u0275advance(221);
    \u0275\u0275property("options", ctx.calendarOptions)("events", ctx.calendarEvents);
  }
}, dependencies: [SharedModule, TaskDashboardPageHeaderComponent, NgbModule, FullCalendarModule, FullCalendarComponent, NgSelectModule, NgSelectComponent, NgOptionComponent, MaterialModuleModule, CalendarModule, FormsModule, ReactiveFormsModule, FlatpickrModule, FlatpickrDirective, RouterModule] });
...
//# sourceMappingURL=overview-calendar.component-F4OATQCW.js.map
